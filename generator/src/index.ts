...
import { generateRouteImports, generateRouteRegistrations } from "./generators/server-route-generator";
...
writeGeneratedFile(serverPath, generateServer(routeImports,routeRegistrations))
...
writeGeneratedFile(prismaSchemaPath, `${generatePrismaSchemaConfig()}\n${models}`);
